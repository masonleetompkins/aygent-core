...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            video::video_create_media_folder, video::video_rename_media_folder, video::video_delete_media_folder, video::video_move_media_assets, video::video_move_media_folder, video::video_pick_folder,
