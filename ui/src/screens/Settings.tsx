...
// ---------------------------------------------------------------------------
// IN-APP BROWSER — Slice 0 UI. Same "click to enable, downloads inside the app"
// UX as Local Models (Mason's explicit ask). Shows install state, an Enable
// button that streams download+extract progress, and a launch probe that PROVES
// the provisioned Chromium runs with no user install + no Gatekeeper block.
// ---------------------------------------------------------------------------
